  ...
  <header class="header">
    <nav class="main-nav">
      ...
      <div class="social-icons">
        ...
        <a href="https://github.com/bryantaolong" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="social-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://space.bilibili.com/1447452471" target="_blank" rel="noopener noreferrer" aria-label="Bilibili" class="social-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
